...
<body>
        ...
        mto=resultSet.getString("mto");
         link="delete_viewinbox.jsp?mid="+mid;
         link2="reply_inbox.jsp?mail="+from;
        %>
        ...
        <tr>   <td><a href=<%=link%>>Delete</a></td>
                <td><a href=<%=link2%>>reply</a></td>
        </tr>
        <%
        }
        resultSet.close();
...
%>
        ...
        <center><button><a href="inbox.jsp">back</a></button></center>
</body>
</html>
